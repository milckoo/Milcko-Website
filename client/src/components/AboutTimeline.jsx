    ...
    >
      <div className="max-w-7xl   mx-auto flex flex-col md:flex-row mt-35 items-center gap-10">
        ...
        <div className="md:w-1/2 relative">
          ...
          <button
            onClick={goPrev}
            className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-white rounded-full shadow p-2 hover:bg-gray-200"
          >
            ◀
          </button>
          <button
            onClick={goNext}
            className="absolute top-1/2 right-0 transform -translate-y-1/2 bg-white rounded-full shadow p-2 hover:bg-gray-200"
          >
            ▶
          </button>
        </div>
