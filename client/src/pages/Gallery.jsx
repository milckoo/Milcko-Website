...
const galleryImageSources = {
  col1: [image1, image2, image3, image4, image5, image6, image7],
  col2: [image8, image9, image10, image11, image12, image13],
  col3: [image14, image15, image16],
};
...
function Gallery() {
  ...
  const getImagesForDisplay = () => {
    if (activeCategory === 'All') {
      const allImages = [
        galleryImageSources.col1[0], galleryImageSources.col2[0], galleryImageSources.col3[0],
        galleryImageSources.col1[1], galleryImageSources.col2[1],
        galleryImageSources.col1[2], galleryImageSources.col3[1],
        galleryImageSources.col1[3], galleryImageSources.col2[2], galleryImageSources.col3[2],
        galleryImageSources.col1[4], galleryImageSources.col2[3],
        galleryImageSources.col1[5], galleryImageSources.col3[6],
        galleryImageSources.col1[6], 
        galleryImageSources.col2[5],galleryImageSources.col2[4]
        
      ].filter(Boolean); // remove undefined if columns are uneven
      return allImages;
    }

    switch (activeCategory) {
      case 'Our Cows':
        return galleryImageSources.col1.slice(0, 3);
      case 'Our Farmers':
        return galleryImageSources.col2.slice(0, 3);
      case 'Delivery Moments':
        return galleryImageSources.col3.slice(0, 3);
      case 'Behind the Scenes':
        return galleryImageSources.col1.slice(3, 6);
      case 'Customers':
        return galleryImageSources.col2.slice(3, 6);
      default:
        return [];
    }
  };
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-[#FEF0D5] to-[#FEF0D500] font-sans py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="columns-1 sm:columns-2 md:columns-3 gap-9 ">
